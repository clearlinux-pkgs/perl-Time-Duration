...
cd ..
%setup -q -T -D -n Time-Duration-1.20 -b 1
mkdir -p deblicense/
...
cp deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Time-Duration/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.1/Time/Duration.pm
...
/usr/share/package-licenses/perl-Time-Duration/deblicense_copyright
